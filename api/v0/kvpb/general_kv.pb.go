...
func (x *GetAllKeysRequest) Reset() {
	*x = GetAllKeysRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v0_kvpb_general_kv_proto_msgTypes[0]
...
func (*GetAllKeysRequest) Descriptor() ([]byte, []int) {
	return file_api_v0_kvpb_general_kv_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetAllKeysResponse) Reset() {
	*x = GetAllKeysResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v0_kvpb_general_kv_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetAllKeysResponse) Descriptor() ([]byte, []int) {
	return file_api_v0_kvpb_general_kv_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetKeyTypeRequest) Reset() {
	*x = GetKeyTypeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v0_kvpb_general_kv_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetKeyTypeRequest) Descriptor() ([]byte, []int) {
	return file_api_v0_kvpb_general_kv_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetKeyTypeResponse) Reset() {
	*x = GetKeyTypeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v0_kvpb_general_kv_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetKeyTypeResponse) Descriptor() ([]byte, []int) {
	return file_api_v0_kvpb_general_kv_proto_rawDescGZIP(), []int{3}
}
...
func (x *DeleteKeysRequest) Reset() {
	*x = DeleteKeysRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v0_kvpb_general_kv_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteKeysRequest) Descriptor() ([]byte, []int) {
	return file_api_v0_kvpb_general_kv_proto_rawDescGZIP(), []int{4}
}
...
func (x *DeleteKeysResponse) Reset() {
	*x = DeleteKeysResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v0_kvpb_general_kv_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteKeysResponse) Descriptor() ([]byte, []int) {
	return file_api_v0_kvpb_general_kv_proto_rawDescGZIP(), []int{5}
}
...
func (x *DeleteAllKeysRequest) Reset() {
	*x = DeleteAllKeysRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v0_kvpb_general_kv_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteAllKeysRequest) Descriptor() ([]byte, []int) {
	return file_api_v0_kvpb_general_kv_proto_rawDescGZIP(), []int{6}
}
...
func (x *DeleteAllKeysResponse) Reset() {
	*x = DeleteAllKeysResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_v0_kvpb_general_kv_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteAllKeysResponse) Descriptor() ([]byte, []int) {
	return file_api_v0_kvpb_general_kv_proto_rawDescGZIP(), []int{7}
}

var File_api_v0_kvpb_general_kv_proto protoreflect.FileDescriptor

var file_api_v0_kvpb_general_kv_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x30, 0x2f, 0x6b, 0x76, 0x70, 0x62, 0x2f, 0x67, 0x65,
	0x6e, 0x65, 0x72, 0x61, 0x6c, 0x5f, 0x6b, 0x76, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b,
	0x61, 0x70, 0x69, 0x2e, 0x76, 0x30, 0x2e, 0x6b, 0x76, 0x70, 0x62, 0x22, 0x13, 0x0a, 0x11, 0x47,
	...
	0x65, 0x79, 0x73, 0x12, 0x1e, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x30, 0x2e, 0x6b, 0x76, 0x70,
	0x62, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x4b, 0x65, 0x79, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x30, 0x2e, 0x6b, 0x76, 0x70,
	...
	0x54, 0x79, 0x70, 0x65, 0x12, 0x1e, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x30, 0x2e, 0x6b, 0x76,
	0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x4b, 0x65, 0x79, 0x54, 0x79, 0x70, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x30, 0x2e, 0x6b, 0x76,
	...
	0x65, 0x4b, 0x65, 0x79, 0x73, 0x12, 0x1e, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x30, 0x2e, 0x6b,
	0x76, 0x70, 0x62, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x73, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x30, 0x2e, 0x6b,
	0x76, 0x70, 0x62, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x73, 0x52, 0x65,
	...
	0x76, 0x30, 0x2e, 0x6b, 0x76, 0x70, 0x62, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x41, 0x6c,
	0x6c, 0x4b, 0x65, 0x79, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x76, 0x30, 0x2e, 0x6b, 0x76, 0x70, 0x62, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74,
	0x65, 0x41, 0x6c, 0x6c, 0x4b, 0x65, 0x79, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x42, 0x0d, 0x5a, 0x0b, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x30, 0x2f, 0x6b, 0x76, 0x70,
	0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_api_v0_kvpb_general_kv_proto_rawDescOnce sync.Once
	file_api_v0_kvpb_general_kv_proto_rawDescData = file_api_v0_kvpb_general_kv_proto_rawDesc
)

func file_api_v0_kvpb_general_kv_proto_rawDescGZIP() []byte {
	file_api_v0_kvpb_general_kv_proto_rawDescOnce.Do(func() {
		file_api_v0_kvpb_general_kv_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_v0_kvpb_general_kv_proto_rawDescData)
	})
	return file_api_v0_kvpb_general_kv_proto_rawDescData
}

var file_api_v0_kvpb_general_kv_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_api_v0_kvpb_general_kv_proto_goTypes = []interface{}{
	(*GetAllKeysRequest)(nil),     // 0: api.v0.kvpb.GetAllKeysRequest
	(*GetAllKeysResponse)(nil),    // 1: api.v0.kvpb.GetAllKeysResponse
	(*GetKeyTypeRequest)(nil),     // 2: api.v0.kvpb.GetKeyTypeRequest
	(*GetKeyTypeResponse)(nil),    // 3: api.v0.kvpb.GetKeyTypeResponse
	(*DeleteKeysRequest)(nil),     // 4: api.v0.kvpb.DeleteKeysRequest
	(*DeleteKeysResponse)(nil),    // 5: api.v0.kvpb.DeleteKeysResponse
	(*DeleteAllKeysRequest)(nil),  // 6: api.v0.kvpb.DeleteAllKeysRequest
	(*DeleteAllKeysResponse)(nil), // 7: api.v0.kvpb.DeleteAllKeysResponse
}
var file_api_v0_kvpb_general_kv_proto_depIdxs = []int32{
	0, // 0: api.v0.kvpb.GeneralKVService.GetAllKeys:input_type -> api.v0.kvpb.GetAllKeysRequest
	2, // 1: api.v0.kvpb.GeneralKVService.GetKeyType:input_type -> api.v0.kvpb.GetKeyTypeRequest
	4, // 2: api.v0.kvpb.GeneralKVService.DeleteKeys:input_type -> api.v0.kvpb.DeleteKeysRequest
	6, // 3: api.v0.kvpb.GeneralKVService.DeleteAllKeys:input_type -> api.v0.kvpb.DeleteAllKeysRequest
	1, // 4: api.v0.kvpb.GeneralKVService.GetAllKeys:output_type -> api.v0.kvpb.GetAllKeysResponse
	3, // 5: api.v0.kvpb.GeneralKVService.GetKeyType:output_type -> api.v0.kvpb.GetKeyTypeResponse
	5, // 6: api.v0.kvpb.GeneralKVService.DeleteKeys:output_type -> api.v0.kvpb.DeleteKeysResponse
	7, // 7: api.v0.kvpb.GeneralKVService.DeleteAllKeys:output_type -> api.v0.kvpb.DeleteAllKeysResponse
...
func init() { file_api_v0_kvpb_general_kv_proto_init() }
func file_api_v0_kvpb_general_kv_proto_init() {
	if File_api_v0_kvpb_general_kv_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_api_v0_kvpb_general_kv_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v0_kvpb_general_kv_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v0_kvpb_general_kv_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v0_kvpb_general_kv_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v0_kvpb_general_kv_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v0_kvpb_general_kv_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v0_kvpb_general_kv_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v0_kvpb_general_kv_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_v0_kvpb_general_kv_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_v0_kvpb_general_kv_proto_goTypes,
		DependencyIndexes: file_api_v0_kvpb_general_kv_proto_depIdxs,
		MessageInfos:      file_api_v0_kvpb_general_kv_proto_msgTypes,
	}.Build()
	File_api_v0_kvpb_general_kv_proto = out.File
	file_api_v0_kvpb_general_kv_proto_rawDesc = nil
	file_api_v0_kvpb_general_kv_proto_goTypes = nil
	file_api_v0_kvpb_general_kv_proto_depIdxs = nil
}
