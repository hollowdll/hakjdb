...
type SetHashMapRequest struct {
	...
	FieldValueMap map[string][]byte `protobuf:"bytes,2,rep,name=field_value_map,json=fieldValueMap,proto3" json:"field_value_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *SetHashMapRequest) GetFieldValueMap() map[string][]byte {
	if x != nil {
...
type GetAllHashMapFieldsAndValuesResponse struct {
	...
	FieldValueMap map[string][]byte `protobuf:"bytes,1,rep,name=field_value_map,json=fieldValueMap,proto3" json:"field_value_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// True if the key exists. False if it doesn't exist.
	Ok bool `protobuf:"varint,2,opt,name=ok,proto3" json:"ok,omitempty"`
}
...
var file_api_v1_kvpb_hashmap_kv_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x6f, 0x6b, 0x18,
